...
int main() {
	...
	// -------------------------
	{
		...
		try {
			...
			std::cout
				<< testing::GREEN
				<< "[SUCCESS] invalid_argument exception thrown! Path parameter duplication tests passed!"
				<< " Got: " << ex.what()
				<< testing::RESET
				<< std::endl;
		}
		...
		try {
			...
			std::cout
				<< testing::GREEN
				<< "[SUCCESS] invalid_argument exception thrown! Path parameter ambiguity tests passed!"
				<< " Got: " << ex.what()
				<< testing::RESET
				<< std::endl;
		}
